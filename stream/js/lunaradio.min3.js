...
!function(e, t) {
    ...
    "use strict";
    e.fn.lunaradio = function(a) {
        var i = "string" == typeof a
          , o = Array.prototype.slice.call(arguments, 1)
          , r = this;
        return a = !i && o.length ? e.extend.apply(null, [!0, a].concat(o)) : a,
        i && "_" === a.charAt(0) ? r : (i ? this.each(function() {
            var i = e(this).data("lunaradio")
              , n = i && e.isFunction(i[a]) ? i[a].apply(i, o) : i;
            if (n !== i && n !== t)
                return r = n,
                !1
        }) : this.each(function() {
            e(this).data("lunaradio", new e.lunaradio(this,a))
        }),
        r)
    }
    ,
    e.lunaradio = function(a, i) {
        var o = a.id;
        if (arguments.length) {
            this.element = e(a),
        ...
        function Qe(t) {
            n = t,
            xt("autoplay: " + re),
            "real" != O || "safari" != Me.browser.name.toLowerCase() && !wt() || (O = "fake");
            try {
                var i = window.localStorage.getItem(n + "volume");
                null === i || (ie = parseInt(i))
            } catch (e) {
                xt(e)
            }
            var o, r, s, l;
            ...
            "" != B && Ye(B),
            o = "@keyframes " + n + "pulse { ",
            o = (o = (o = (o = (o = (o = (o = (o = (o = (o += "\t0% { ") + "\t  fill: rgba(" + At(M).r + ", " + At(M).g + ", " + At(M).b + ", 1.0);") + "\t} ") + "\t50% { ") + "\t  fill: rgba(" + At(I).r + ", " + At(I).g + ", " + At(I).b + ", 1.0); ") + "\t} ") + "\t100% { ") + "\t\tfill: rgba(" + At(M).r + ", " + At(M).g + ", " + At(M).b + ", 1.0); ") + "\t} ") + "}",
            e("head").append('<style type="text/css">' + o + "</style>"),
            r = window.location.href.toString().toLocaleLowerCase(),
            s = vt(E).toString(),
            "" != E && -1 != r.indexOf(s) && s.length > 4 || -1 != r.indexOf(vt("ZFNWW2FiXlNrV2QgXmdgUx9nYFtoV2RlVyBVYV8=").toString()) || (l = vt("SURBQDkSRkE9N0ATExMSQj43M0U3Ejk3RhIzEkA3SRJGQT03QBJBQCwSWmZmYmUsISFkU1ZbYWJeU2tXZCBeZ2BTH2dgW2hXZGVXIFVhXyFkV1lbZWZXZA=="),
            xe = !0,
            document.getElementById(n).innerHTML = l),
            xe || (!function() {
                var t = document.getElementById(n);
                t.innerHTML = "",
                e("#" + n).addClass("lunaaudioplayer").css({
                    overflow: "hidden",
                    display: "block"
                });
                var i = document.createElement("div");
                i.id = n + "containerinside",
                t.appendChild(i),
                e("#" + n + "containerinside").css({
                    position: "relative",
                    left: "0px",
                    top: "0px",
                    height: "100%",
                ...
                m.preload = "auto",
                "true" == re && (xt("autoplay enabled"),
                m.autoplay = !0),
                m.addEventListener("timeupdate", function() {
                    0 == m.paused && (e("#" + n + "audiopreloader").fadeOut(0),
                ...
                m.addEventListener("loadstart", function() {
                    be && (e("#" + n + "audiopreloader").fadeIn(0),
                    e("#" + n + "smallaudiopreloader").fadeIn(0)),
                    xt("loadstart")
                }, !1),
                m.addEventListener("waiting", function() {
                    e("#" + n + "audiopreloader").fadeIn(0),
                    e("#" + n + "smallaudiopreloader").fadeIn(0),
                    xt("waiting")
                }, !1),
                ...
                m.addEventListener("canplaythrough", function() {
                    e("#" + n + "audiopreloader").fadeOut(0),
                    e("#" + n + "smallaudiopreloader").fadeOut(0),
                    e("#" + n + "iconlive, #" + n + "smalliconlive").css({
                        opacity: "1.0"
                    }),
                    xt("canplaythrough")
                }, !1),
                m.addEventListener("pause", function() {
                    m.currentTime.toFixed(1) < m.duration.toFixed(1) && rt(),
                    xt("pause: currentTime: " + m.currentTime.toFixed(1) + " duration: " + m.duration.toFixed(1))
                }, !1),
                ...
                "big" == T && function(t) {
                    ...
                    (i = document.createElement("div")).id = n + "backgroundimage2",
                    a.appendChild(i),
                ...
                "big" == T ? function(t) {
                    var i = document.createElement("div");
                    i.id = n + "playerwrapper",
                    t.appendChild(i),
                    e("#" + n + "playerwrapper").css({
                        overflow: "hidden",
                        display: "block",
                        position: "absolute",
                        left: "0px",
                    ...
                    function(t) {
                        ...
                        (a = document.createElement("div")).id = n + "coverwrapper1",
                        i.appendChild(a),
                        ...
                        (a = document.createElement("div")).id = n + "coverwrapper2",
                        i.appendChild(a),
                    ...
                    (a = document.createElement("div")).id = n + "iconlive",
                    i.appendChild(a),
                    e("#" + n + "iconlive").css({
                        position: "absolute",
                        fill: "rgba(" + At(M).r + ", " + At(M).g + ", " + At(M).b + ", 0.3)",
                        animation: n + "pulse 2s infinite"
                    }).html(y).lunaradiodisableSelection(),
                    "false" == ne && e("#" + n + "iconlive").css({
                        display: "none"
                    });
                    (a = document.createElement("div")).id = n + "buttonvolumeoff",
                    i.appendChild(a),
                    ...
                    (a = document.createElement("div")).id = n + "buttonvolumeon",
                    i.appendChild(a),
                    ...
                    (a = document.createElement("div")).id = n + "buttonanalyzer",
                    i.appendChild(a),
                    e("#" + n + "buttonanalyzer").css({
                        ...
                        !function() {
                            if ("none" != e("#" + n + "buttonshuffle").css("pointer-events")) {
                                ...
                                try {
                                    window.localStorage.removeItem(n + "visualizer"),
                                    window.localStorage.setItem(n + "visualizer", D)
                                } catch (e) {
                                    xt(e)
                                }
                                xt("changeanalyzer: " + D)
                    ...
                    "false" == se && e("#" + n + "buttonanalyzer").css({
                        display: "none"
                    });
                    (a = document.createElement("span")).classList.add(n + "textradionamespan"),
                    i.appendChild(a),
                    e("." + n + "textradionamespan").css({
                        "padding-left": "10px",
                        "padding-right": "10px",
                        margin: "0",
                        "white-space": "nowrap",
                    ...
                    (a = document.createElement("div")).id = n + "textradioname",
                    a.dataset.speed = .5,
                    a.dataset.reverse = !0,
                    i.appendChild(a),
                    e("#" + n + "textradioname").css({
                        ...
                        "font-family": z,
                        color: M
                    }).addClass(n + "textradioname").html(e("." + n + "textradionamespan")).lunaradiodisableSelection(),
                    "true" != N && e("#" + n + "textradioname").css({
                        "text-overflow": "ellipsis"
                    });
                    (a = document.createElement("span")).classList.add(n + "texttitlespan"),
                    i.appendChild(a),
                    e("." + n + "texttitlespan").css({
                        "padding-left": "10px",
                        "padding-right": "10px",
                        margin: "0",
                        "white-space": "nowrap",
                    ...
                    (a = document.createElement("div")).id = n + "texttitle",
                    a.dataset.speed = .9,
                    i.appendChild(a),
                    e("#" + n + "texttitle").css({
                        position: "absolute",
                        ...
                        "font-family": z,
                        color: M
                    }).addClass(n + "texttitle").html(e("." + n + "texttitlespan")).lunaradiodisableSelection(),
                    "true" != N && e("#" + n + "texttitle").css({
                        "text-overflow": "ellipsis"
                    });
                    (a = document.createElement("div")).id = n + "textvolumeend",
                    i.appendChild(a),
                    ...
                    function(t) {
                        var a = document.createElement("div");
                        a.id = n + "volumewrapper",
                        t.appendChild(a),
                        e("#" + n + "volumewrapper").css({
                            position: "absolute"
                        }).lunaradiodisableSelection();
                        var i = document.createElement("div");
                        i.id = n + "volumebackground",
                        a.appendChild(i),
                        e("#" + n + "volumebackground").css({
                            position: "absolute",
                            width: "100%",
                            background: M
                        }).lunaradiodisableSelection(),
                        (i = document.createElement("div")).id = n + "volumefill",
                        a.appendChild(i),
                        e("#" + n + "volumefill").css({
                            position: "absolute",
                            width: "0",
                        ...
                        (i = document.createElement("div")).id = n + "volumeicon",
                        a.appendChild(i),
                        e("#" + n + "volumeicon").css({
                            position: "absolute",
                            top: "0px",
                        ...
                        (i = document.createElement("img")).id = n + "volumegrab",
                        a.appendChild(i),
                        i.src = C,
                        e("#" + n + "volumegrab").css({
                            position: "absolute",
                            ...
                            onmove: function(t) {
                                var a = 100 * t.offset.x / e("#" + n + "volumewrapper").width();
                                we = ve + a < 100 ? ve + a : 100,
                                ve + a < 0 && (we = 0),
                                $e(we)
                            },
                            onfinish: function(t) {
                                e(this).css("cursor", k);
                                try {
                                    window.localStorage.removeItem(n + "volume"),
                                    window.localStorage.setItem(n + "volume", we)
                                } catch (e) {
                                    xt(e)
                                }
                            }
                    ...
                    function(t) {
                        ...
                        (i = document.createElement("div")).id = n + "buttonpause",
                        a.appendChild(i),
                        e("#" + n + "buttonpause").css({
                            position: "absolute",
                            top: "0px",
                        ...
                        (i = document.createElement("div")).id = n + "audiopreloader",
                        a.appendChild(i),
                        e("#" + n + "audiopreloader").css({
                            position: "absolute",
                            top: "0px",
                            left: "0px",
                            width: "100%",
                    ...
                    xt("iniSmallPlayer");
                    var a = document.createElement("div");
                    a.id = n + "smallplayerwrapper",
                    t.appendChild(a),
                    e("#" + n + "smallplayerwrapper").css({
                        overflow: "hidden",
                        position: "absolute",
                        left: "0px",
                        top: "0px",
                    ...
                    (i = document.createElement("div")).id = n + "smalliconlive",
                    a.appendChild(i),
                    e("#" + n + "smalliconlive").css({
                        position: "absolute",
                        fill: "rgba(" + At(M).r + ", " + At(M).g + ", " + At(M).b + ", 0.3)"
                    }).html(y).lunaradiodisableSelection(),
                    "false" == ne && e("#" + n + "smalliconlive").css({
                        display: "none"
                    });
                    (i = document.createElement("div")).id = n + "smalltextvolume",
                    a.appendChild(i),
                    ...
                    (i = document.createElement("div")).id = n + "smalliconvolume",
                    a.appendChild(i),
                    e("#" + n + "smalliconvolume").css({
                        position: "absolute",
                        fill: "rgba(" + At(M).r + ", " + At(M).g + ", " + At(M).b + ", 0.3)"
                    }).html(x).lunaradiodisableSelection(),
                    (i = document.createElement("span")).classList.add(n + "smalltextradionamespan"),
                    a.appendChild(i),
                    e("." + n + "smalltextradionamespan").css({
                        "padding-right": "30px",
                        margin: "0",
                        "white-space": "nowrap",
                        "font-family": z,
                    ...
                    (i = document.createElement("div")).id = n + "smalltextradioname",
                    i.dataset.speed = .5,
                    i.dataset.reverse = !0,
                    a.appendChild(i),
                    e("#" + n + "smalltextradioname").css({
                        ...
                        "font-family": z,
                        color: M
                    }).addClass(n + "smalltextradioname").html(e("." + n + "smalltextradionamespan")).lunaradiodisableSelection(),
                    "true" != N && e("#" + n + "smalltextradioname").css({
                        "text-overflow": "ellipsis"
                    });
                    (i = document.createElement("span")).classList.add(n + "smalltexttitlespan"),
                    a.appendChild(i),
                    e("." + n + "smalltexttitlespan").css({
                        "padding-right": "30px",
                        margin: "0",
                        "white-space": "nowrap",
                        "font-family": z,
                    ...
                    (i = document.createElement("div")).id = n + "smalltexttitle",
                    i.dataset.speed = .7,
                    a.appendChild(i),
                    e("#" + n + "smalltexttitle").css({
                        ...
                        "font-family": z,
                        color: M
                    }).addClass(n + "smalltexttitle").html(e("." + n + "smalltexttitlespan")).lunaradiodisableSelection(),
                    "true" != N && e("#" + n + "smalltexttitle").css({
                        "text-overflow": "ellipsis"
                    });
                    (i = document.createElement("div")).id = n + "smallvolumegrab",
                    a.appendChild(i),
                    e("#" + n + "smallvolumegrab").css({
                        ...
                        onmove: function(t) {
                            var a = 100 * t.offset.x / e("#" + n + "smallvolumegrab").width();
                            we = ve + a < 100 ? ve + a : 100,
                            ve + a < 0 && (we = 0),
                            et(we)
                        },
                    ...
                    function(t) {
                        ...
                        var i = document.createElement("div");
                        i.id = n + "smallbuttonplay",
                        a.appendChild(i),
                        e("#" + n + "smallbuttonplay").css({
                            position: "absolute",
                            top: "0px",
                            left: "0px",
                            width: "100%",
                        ...
                        (i = document.createElement("div")).id = n + "smallbuttonpause",
                        a.appendChild(i),
                        e("#" + n + "smallbuttonpause").css({
                            position: "absolute",
                            top: "0px",
                            left: "0px",
                            width: "100%",
                        ...
                        (i = document.createElement("div")).id = n + "smallaudiopreloader",
                        a.appendChild(i),
                        e("#" + n + "smallaudiopreloader").css({
                            position: "absolute",
                            top: "0px",
                            left: "0px",
                            width: "100%",
                    ...
                    function(t) {
                        ...
                        (i = document.createElement("div")).id = n + "smallcoverwrapper2",
                        a.appendChild(i),
                ...
                ut(),
                "true" == F ? (F = "false",
                Je(P + "?" + Math.floor(Math.random() * Math.floor(99999)), ""),
                F = "true") : Je(P, "");
                He(),
                            ...
                            success: function(e) {
                                try {
                                    ...
                                    if (e.icestats.source.length === t)
                                        ...
                                        for (var i = 0; i < e.icestats.source.length; i++) {
                                            var o = e.icestats.source[i].listenurl;
                                            Y == o.substr(o.length - Y.length, Y.length) && (a = e.icestats.source[i])
                                        }
                                    var r = ""
                                      , n = "";
                                    a.hasOwnProperty("title") && (n = a.title),
                                    a.hasOwnProperty("artist") && (r = a.artist),
                                    Ke("" != r && "" != n ? r + " - " + n : "" != r ? r : n, "")
                                } catch (e) {
                                    xt("Error on JSON File: " + e),
                                    Ke("", "")
                                }
                            },
                            error: function(e, t, a) {
                                xt("Error on JSON File: " + t),
                                Ke("", "")
                            }
                        })
                    }();
                ...
                case "radionomy":
                    !function() {
                        ...
                        e.ajax({
                            ...
                            success: function(t) {
                                try {
                                    var a = e(t).find("track").find("artists").text();
                                    e(t).find("track").find("title").text() != e(t).find("track").find("artists").text() && (a += " - " + e(t).find("track").find("title").text());
                                    var i = e(t).find("track").find("cover").text();
                                    Ke(a, i)
                                } catch (e) {
                                    Ke("", "")
                                }
        ...
        function Ke(t, a) {
            fe != e("<div/>").html(t).text() && (xt("New Title: " + (fe = e("<div/>").html(t).text())),
            ...
            F = "true") : function() {
                if ("" != fe) {
                    var t = fe.replace(/ *\([^)]*\) */g, "")
                      , a = "https://itunes.apple.com/search?term=" + encodeURIComponent(t) + "&media=music&limit=1&url=" + encodeURIComponent(Oe)
                      , i = a
                      , o = i
                      , r = "GET";
                    wt() && (r = "POST",
                    ...
                    e.ajax({
                        ...
                        success: function(e) {
                            try {
                                ...
                                var t = ""
                                  , a = "";
                                1 == e.results.length ? (xt("COVER: " + (t = (t = e.results[0].artworkUrl100).replace("100x100bb", "600x600bb"))),
                                "" != V && (a = e.results[0].trackViewUrl + "&app=itunes&at=" + V),
                                Je(t, a)) : Je(P, "")
                            } catch (e) {
                                Je(P, "")
                            }
        ...
        function Je(t, a) {
            "false" == F && ("" != (ze = a) ? e("#" + n + "coverwrapper, #" + n + "smallcoverwrapper").css({
                cursor: "pointer"
            }) : e("#" + n + "coverwrapper, #" + n + "smallcoverwrapper").css({
                cursor: "hand"
            }),
            ++Te > 2 && (Te = 1),
            e("<img/>").attr("src", t).on("load", function() {
                e(this).remove(),
        ...
        function _e(t) {
            if ("true" == N) {
                var a = "";
                "small" == T && (a = "small"),
                t && e("#" + n + a + "texttitle").hasClass(n + "Marquee") && (e("#" + n + a + "texttitle").removeClass(n + "Marquee"),
                e("#" + n + a + "texttitle").html(e("." + n + a + "texttitlespan").first()),
                e("#" + n + a + "texttitle").data("lunaradioMarquee").pause()),
                e("#" + n + a + "textradioname").width() > e("." + n + a + "textradionamespan").first().width() + 10 ? e("#" + n + a + "textradioname").hasClass(n + "Marquee") && (e("#" + n + a + "textradioname").removeClass(n + "Marquee"),
                e("#" + n + a + "textradioname").html(e("." + n + a + "textradionamespan").first()),
                e("#" + n + a + "textradioname").data("lunaradioMarquee").pause()) : e("#" + n + a + "textradioname").hasClass(n + "Marquee") || (e("#" + n + a + "textradioname").addClass(n + "Marquee"),
                e("#" + n + a + "textradioname").html(e("." + n + a + "textradionamespan").first()),
                e("#" + n + a + "textradioname").lunaradioMarquee()),
                e("#" + n + a + "texttitle").width() > e("." + n + a + "texttitlespan").first().width() + 10 ? e("#" + n + a + "texttitle").hasClass(n + "Marquee") && (e("#" + n + a + "texttitle").removeClass(n + "Marquee"),
                e("#" + n + a + "texttitle").html(e("." + n + a + "texttitlespan").first()),
                e("#" + n + a + "texttitle").data("lunaradioMarquee").pause()) : e("#" + n + a + "texttitle").hasClass(n + "Marquee") || (e("#" + n + a + "texttitle").addClass(n + "Marquee"),
                e("#" + n + a + "texttitle").html(e("." + n + a + "texttitlespan").first()),
                e("#" + n + a + "texttitle").lunaradioMarquee())
            }
        }
        function $e(t) {
            t < 0 && (t = 0),
            t > 100 && (t = 100),
            wt() || (m.volume = t / 100);
            var a = e("#" + n + "volumewrapper").width() * t / 100;
            e("#" + n + "volumefill").css({
                width: a + "px"
            }),
            e("#" + n + "volumeicon").css({
                left: a - e("#" + n + "volumeicon").width() / 2 + "px"
            }),
        ...
        function et(t) {
            ...
            var a = e("#" + n + "smallvolumegrab").width() * t / 100;
            e("#" + n + "smallvolumebackground").css({
                width: a + "px"
            }),
            d.width = a,
        ...
        function tt() {
            ge = e("#" + n + "containerinside").width(),
            me = e("#" + n + "containerinside").height(),
            De && "small" == T && (me = Ue,
            ge < 959 && (me = Ge),
            ge < 599 && (me = Ve),
            e("#" + n).css({
        ...
        function at() {
            ...
            "big" == T ? function() {
                ...
                e("#" + n + "iconlive").css({
                    top: m + "px",
                    left: ge / 2 + i / 1.25 + Pe + "px",
                    height: o + "px",
                    width: o + "px"
                }),
                e("#" + n + "buttonanalyzer").css({
                    top: m + "px",
                    left: ge / 2 - i / 1.25 - Pe - o + "px",
                    height: o + "px",
                    width: o + "px"
                }),
                $e(we),
        ...
        function it() {
            "none" != e("#" + n + "buttonplay").css("pointer-events") && (e("#" + n + "buttonpause").stop(),
            e("#" + n + "buttonplay").stop(),
            e("#" + n + "smallbuttonpause").stop(),
            e("#" + n + "smallbuttonplay").stop())
        }
        function ot() {
            be = !0,
        ...
        e(document).ready(function() {
            if (xt("SCRIPT FOLDER: " + (Oe = function(e) {
                var t, a, i, o = document.getElementsByTagName("script");
                for (t = 0; a = o[t]; t++)
                    if ((i = a.src).indexOf(e) >= 0)
                        var r = i.substring(0, i.indexOf(e));
                return r
            }("lunaradio.min.js"))),
            ...
            "true" == re) {
                ...
                try {
                    ...
                    e.addEventListener("play", function() {
                        xt("checkaudio play"),
                        xt("autoplay is allowed by browser"),
                        re = "true"
                    }, !1),
                    ...
                    e.addEventListener("canplaythrough", function() {
                        xt("checkaudio canplaythrough"),
                        Qe(o)
                    }, !1),
                    e.addEventListener("pause", function() {
                        xt("checkaudio pause")
                    }, !1),
                    e.src = "data:audio/mpeg;base64,"
                } catch (e) {
                    xt("autoplay is not allowed by browser"),
                    xt(e),
                    re = "false",
                    Qe(o)
                }
                ...
                if (void 0 === l) {
                    if ("real" == O) {
                        try {
                            ...
                            c = l.createAnalyser(),
                            (t = (e = l).createScriptProcessor(512)).onaudioprocess = dt,
                            t.averaging = .98,
                            t.connect(e.destination),
                            u = t,
                            c.smoothingTimeConstant = .9,
                            c.fftSize = 1024,
                        ...
                        try {
                            "crossOrigin"in m ? (xt("found crossOrigin"),
                            ...
                            xt("analyzer is connected")) : xt("no crossOrigin")
                        } catch (e) {
                            xt("error" + e)
                        }
                    }
                } else
                    xt("analyzer_audioContext is not undefined");
                var e, t
            }(),
            We(),
            wt()) {
        ...
        function dt(e) {
            for (var t, a = e.inputBuffer.getChannelData(0), i = e.inputBuffer.getChannelData(1), o = a.length, r = i.length, n = 0, s = 0; s < o; s++)
                n += (t = a[s]) * t;
            var l = Math.sqrt(n / o);
            Ae = Math.max(l, Ae * this.averaging),
            n = 0,
            t = 0;
            for (s = 0; s < r; s++)
                n += (t = i[s]) * t;
            l = Math.sqrt(n / r),
            ye = Math.max(l, ye * this.averaging)
        }
        function ct(e) {
        ...
        function ut() {
            if ("fake" == O || "real" == O) {
                ...
                if ("fake" == O) {
                    Ce = [];
                    for (var t = 0; t < 511; t += 1)
                        be ? Ce.push(Math.floor(Math.random() * (254 / (t / 100 + 1)) + 1)) : Ce.push(0),
                        Ee[t] = Ee[t] + (Ce[t] - Ee[t]) / 9;
                    Ce = Ee
                }
                try {
                    "real" == O && (Ce = new Uint8Array(c.frequencyBinCount),
                    c.getByteFrequencyData(Ce))
                } catch (e) {}
                ...
                try {
                    ...
                    case 1:
                        !function() {
                            ...
                            p.closePath(),
                            p.beginPath();
                            for (var e = 0; e < Ce.length / 2; e += 1)
                                p.lineTo(e * d.width / Ce.length * 2, d.height - Ce[e] * d.height / 255 + 2);
                            if ("true" == le) {
                                var t = p.createLinearGradient(0, 0, d.width, 0);
                                t.addColorStop(0, "rgba(" + At(de).r + ", " + At(de).g + ", " + At(de).b + ", 0.99)"),
                                t.addColorStop(.33 - Ce[20] / 1e3, "rgba(" + At(ce).r + ", " + At(ce).g + ", " + At(ce).b + ", 0.99)"),
                                t.addColorStop(.66 + Ce[20] / 1e3, "rgba(" + At(ue).r + ", " + At(ue).g + ", " + At(ue).b + ", 0.99)"),
                                t.addColorStop(1, "rgba(" + At(pe).r + ", " + At(pe).g + ", " + At(pe).b + ", 0.99)"),
                                p.strokeStyle = t
                            } else
                                p.strokeStyle = "rgba(" + At(I).r + ", " + At(I).g + ", " + At(I).b + ", 0.99)";
                            p.stroke()
                        }();
                        break;
                    case 2:
                        !function() {
                            ...
                            "true" == le) {
                                ...
                                p.fillStyle = "rgba(" + At(I).r + ", " + At(I).g + ", " + At(I).b + ", 0.99)";
                            p.fill()
                        }();
                        break;
                    case 3:
                        !function() {
                            ...
                            for (var e = 0; e < d.width; e += 6) {
                                ...
                                p.moveTo(e, d.height),
                                p.lineTo(e, d.height - Ce[t] * d.height / 255 + 2)
                            }
                            if ("true" == le) {
                                var a = p.createLinearGradient(0, 0, d.width, 0);
                                a.addColorStop(0, "rgba(" + At(de).r + ", " + At(de).g + ", " + At(de).b + ", 0.99)"),
                                a.addColorStop(.33 - Ce[20] / 1e3, "rgba(" + At(ce).r + ", " + At(ce).g + ", " + At(ce).b + ", 0.99)"),
                                a.addColorStop(.66 + Ce[20] / 1e3, "rgba(" + At(ue).r + ", " + At(ue).g + ", " + At(ue).b + ", 0.99)"),
                                a.addColorStop(1, "rgba(" + At(pe).r + ", " + At(pe).g + ", " + At(pe).b + ", 0.99)"),
                                p.strokeStyle = a,
                                p.stroke()
                            } else
                                p.strokeStyle = "rgba(" + At(I).r + ", " + At(I).g + ", " + At(I).b + ", 0.99)",
                    ...
                    case 4:
                        !function() {
                            ...
                            for (var t = 0; t < ge + 20; t += 20) {
                                var a = Math.round(Ce.length / 8 * t / ge);
                                e.push(t),
                                e.push(d.height - Ce[a] * d.height / 255 + 2)
                            }
                            ht(p, e, .5),
                            ...
                            for (var t = 0; t < ge + 20; t += 20) {
                                var a = Math.round(Ce.length / 8 * t / ge);
                                e.push(t),
                                e.push(d.height - Ce[a + a] * d.height / 255 + 2)
                            }
                            ht(p, e, .5),
                            p.lineTo(ge, d.height),
                            p.lineTo(0, d.height),
                            ...
                            for (var t = 0; t < ge + 20; t += 20) {
                                var a = Math.round(Ce.length / 8 * t / ge);
                                e.push(t),
                                e.push(d.height - Ce[a + a + a] * d.height / 255 + 2)
                            }
                            ht(p, e, .5),
                            p.lineTo(ge, d.height),
                            p.lineTo(0, d.height),
                            ...
                            for (var t = 0; t < ge + 20; t += 20) {
                                var a = Math.round(Ce.length / 8 * t / ge);
                                e.push(t),
                                e.push(d.height - Ce[a + a + a + a] * d.height / 255 + 2)
                            }
                            ht(p, e, .5),
                            p.lineTo(ge, d.height),
                            p.lineTo(0, d.height),
                    ...
                    case 6:
                        !function() {
                            var e = d.height
                              , t = e / 2;
                            "big" == T && (t = me / 2 + me / 8 + Ne * me / 100 * 4 + me / 32,
                            e = 2 * (d.height - t));
                            p.clearRect(0, 0, d.width, d.height),
                            p.lineWidth = 2,
                            p.lineJoin = "round",
                            p.beginPath();
                            for (var a = 0; a < d.width; a += 6) {
                                var i = Math.round(Ce.length / 2 * a / d.width);
                                p.moveTo(a, t),
                                p.lineTo(a, t - Ce[i] * e / 2 / 255),
                                p.moveTo(a, t),
                                p.lineTo(a, t + Ce[i] * e / 2 / 255)
                            }
                            for (var a = 3; a < d.width; a += 6) {
                                var i = Math.round(Ce.length / 2 * a / d.width);
                                p.moveTo(a, t),
                                p.lineTo(a, t - Ce[i] * e / 4 / 255),
                                p.moveTo(a, t),
                                p.lineTo(a, t + Ce[i] * e / 4 / 255)
                            }
                            if ("true" == le) {
                                ...
                                o.addColorStop(.33 - Ce[20] / 1e3, "rgba(" + At(ce).r + ", " + At(ce).g + ", " + At(ce).b + ", 0.99)"),
                                o.addColorStop(.66 + Ce[20] / 1e3, "rgba(" + At(ue).r + ", " + At(ue).g + ", " + At(ue).b + ", 0.99)"),
                    ...
                    case 7:
                        !function() {
                            if (p.clearRect(0, 0, d.width, d.height),
                            Se++,
                            "true" == le)
                                for (var e = 0; e < Ce.length / 2; e++)
                                    ...
                                    p.closePath(),
                                    p.fillStyle = e % 2 == 0 ? "rgba(" + At(de).r + ", " + At(de).g + ", " + At(de).b + ", 0.2)" : e % 3 == 0 ? "rgba(" + At(ce).r + ", " + At(ce).g + ", " + At(ce).b + ", 0.2)" : e % 5 == 0 ? "rgba(" + At(ue).r + ", " + At(ue).g + ", " + At(ue).b + ", 0.2)" : "rgba(" + At(pe).r + ", " + At(pe).g + ", " + At(pe).b + ", 0.2)",
                                    p.fill();
                            else
                                for (var e = 0; e < Ce.length / 2; e++)
                                    p.beginPath(),
                    ...
                    case 8:
                        !function() {
                            ...
                            var e = d.height / 2
                              , t = d.height / 2
                              , a = 0;
                            "big" == T && (t = me / 2 + me / 8 + Ne * me / 100 * 4 + me / 32 - me / 8 / 2 / 4 / 2 / 2,
                            e = me / 32,
                            a = 2 * Pe);
                            p.lineWidth = 4,
                            p.lineJoin = "round",
                            p.beginPath();
                            for (var i = Math.round(200 * Ae * (d.width - 2 * Pe) / 100), o = a; o < i; o += 6)
                                p.moveTo(o, t),
                                p.lineTo(o, t - e);
                            for (var r = Math.round(200 * ye * (d.width - 2 * Pe) / 100), o = a; o < r; o += 6)
                                p.moveTo(o, t),
                                p.lineTo(o, t + e);
                            if ("true" == le) {
                                var n = p.createLinearGradient(0, 0, d.width, 0);
                                n.addColorStop(0, "rgba(" + At(de).r + ", " + At(de).g + ", " + At(de).b + ", 0.99)"),
                                n.addColorStop(.33 - Ce[20] / 1e3, "rgba(" + At(ce).r + ", " + At(ce).g + ", " + At(ce).b + ", 0.99)"),
                                n.addColorStop(.66 + Ce[20] / 1e3, "rgba(" + At(ue).r + ", " + At(ue).g + ", " + At(ue).b + ", 0.99)"),
                    ...
                    case 9:
                        !function() {
                            ...
                            var e = 0
                              , t = 0
                              , a = 0;
                            for (p.clearRect(0, 0, d.width, d.height),
                            p.miterLimit = 1,
                            t = 0; t < 10; t += 1) {
                                for (p.beginPath(),
                                p.lineWidth = 2 - t / 10,
                                p.moveTo(0, d.height - Ce[0] * d.height / 255 + 2 + 5 * t),
                                e = 0; e < Ce.length / 2; e += 1)
                                    a = Math.round(Ce.length / 1 * e / ge),
                                    p.lineTo(e * d.width / Ce.length * 2 + 5 * t, d.height - Ce[a] * d.height / 255 + 2 + 5 * t);
                                for (p.moveTo(0, d.height - Ce[0] * d.height / 255 + 2 + 5 * t),
                                e = 0; e < Ce.length / 2; e += 1)
                                    a = Math.round(Ce.length / 1 * e / ge),
                                    p.lineTo(e * d.width / Ce.length * 2 + 5 * t, d.height - Ce[a + a] * d.height / 255 + 2 + 5 * t);
                                for (p.moveTo(0, d.height - Ce[0] * d.height / 255 + 2 + 5 * t),
                                e = 0; e < Ce.length / 2; e += 1)
                                    a = Math.round(Ce.length / 1 * e / ge),
                                    p.lineTo(e * d.width / Ce.length * 2 + 5 * t, d.height - Ce[a + a + a] * d.height / 255 + 2 + 5 * t);
                                for (p.moveTo(0, d.height - Ce[0] * d.height / 255 + 2 + 5 * t),
                                e = 0; e < Ce.length / 2; e += 1)
                                    a = Math.round(Ce.length / 1 * e / ge),
                                    p.lineTo(e * d.width / Ce.length * 2 + 5 * t, d.height - Ce[a + a + a + a] * d.height / 255 + 2 + 5 * t);
                                if ("true" == le) {
                                    var i = p.createLinearGradient(0, 0, d.width, 0);
                                    i.addColorStop(0, "rgba(" + At(de).r + ", " + At(de).g + ", " + At(de).b + ", " + t / 10 + ")"),
                                    i.addColorStop(.33 - Ce[20] / 1e3, "rgba(" + At(ce).r + ", " + At(ce).g + ", " + At(ce).b + ", " + t / 10 + ")"),
                                    i.addColorStop(.66 + Ce[20] / 1e3, "rgba(" + At(ue).r + ", " + At(ue).g + ", " + At(ue).b + ", " + t / 10 + ")"),
                                    i.addColorStop(1, "rgba(" + At(pe).r + ", " + At(pe).g + ", " + At(pe).b + ", " + t / 10 + ")"),
                                    p.strokeStyle = i
                                } else
                                    p.strokeStyle = "rgba(" + At(I).r + ", " + At(I).g + ", " + At(I).b + ", " + t / 10 + ")";
                                p.stroke()
                            }
                        }();
                        break;
        ...
        function ht(e, t, a, i, o, r) {
            if (e.beginPath(),
            mt(e, function(e, t, a, i) {
                t = void 0 !== t ? t : .5,
                a = a || !1,
                i = i || 16;
                var o, r, n, s, l, d, c, u, p, h, m, g, f, w = [], v = [];
                w = e.slice(0),
                a ? (w.unshift(e[e.length - 1]),
                w.unshift(e[e.length - 2]),
                w.unshift(e[e.length - 1]),
                w.unshift(e[e.length - 2]),
                w.push(e[0]),
                w.push(e[1])) : (w.unshift(e[1]),
                w.unshift(e[0]),
                w.push(e[e.length - 2]),
                w.push(e[e.length - 1]));
        ...
        function mt(e, t) {
            for (e.moveTo(t[0], t[1]),
            Be = 2; Be < t.length - 1; Be += 2)
                e.lineTo(t[Be], t[Be + 1])
        }
        function gt(t) {
            e({
                countNum: we
        ...
        function vt(e) {
            ...
            var t = 0
              , a = "";
            do {
                a += String.fromCharCode(e.charCodeAt(t++) - -14)
            } while (t < e.length);
            return a
        }
        ...
        var bt = {
            ...
            _utf8_decode: function(e) {
                for (var t = "", a = 0, i = 0, o = 0, r = 0; a < e.length; )
                    (r = e.charCodeAt(a)) < 128 ? (t += String.fromCharCode(r),
                    a++) : r > 191 && r < 224 ? (i = e.charCodeAt(a + 1),
                    t += String.fromCharCode((31 & r) << 6 | 63 & i),
                    a += 2) : (i = e.charCodeAt(a + 1),
                    o = e.charCodeAt(a + 2),
        ...
        function xt(t) {
            if ("true" == oe) {
                var a = new Date;
                t = a.getHours() + ":" + a.getMinutes() + ":" + a.getSeconds() + ": " + t,
                window.console && console.log(t),
                e("#debug").length > 0 && e("#debug").html(e("#debug").html() + "<br>" + t)
            }
        }
        function At(e) {
...
function(e, t) {
    ...
    var a = "model"
      ...
      , c = {
        extend: function(e, t) {
            var a = {};
            for (var i in e)
                t[i] && t[i].length % 2 == 0 ? a[i] = t[i].concat(e[i]) : a[i] = e[i];
            return a
        },
        has: function(e, t) {
      ...
      , u = {
        rgx: function(e, t) {
            for (var a, i, o, r, n, s, l = 0; l < t.length && !n; ) {
                var d = t[l]
                  , c = t[l + 1];
                for (a = i = 0; a < d.length && !n; )
                    if (n = d[a++].exec(e))
                        for (o = 0; o < c.length; o++)
                            s = n[++i],
                            "object" == typeof (r = c[o]) && r.length > 0 ? 2 == r.length ? "function" == typeof r[1] ? this[r[0]] = r[1].call(this, s) : this[r[0]] = r[1] : 3 == r.length ? "function" != typeof r[1] || r[1].exec && r[1].test ? this[r[0]] = s ? s.replace(r[1], r[2]) : void 0 : this[r[0]] = s ? r[1].call(this, s, r[2]) : void 0 : 4 == r.length && (this[r[0]] = s ? r[3].call(this, s.replace(r[1], r[2])) : void 0) : this[r] = s || void 0;
                l += 2
            }
        },
        str: function(e, t) {
      ...
      , m = function(t, a) {
        ...
        return this.getBrowser = function() {
            ...
            return u.rgx.call(e, i, o.browser),
        ...
        this.getDevice = function() {
            ...
            return u.rgx.call(e, i, o.device),
            e
        }
        ,
        this.getEngine = function() {
            ...
            return u.rgx.call(e, i, o.engine),
            e
        }
        ,
        this.getOS = function() {
    ...
    exports.LUNARADIOParser = m) : "function" == typeof define && define.amd ? define(function() {
        return m
...
function(e, t) {
    ...
    "use strict";
    e.fn.lunaradioMarquee = function(a) {
        var i = "lunaradioMarquee"
          , o = "string" == typeof a
          , r = Array.prototype.slice.call(arguments, 1)
          , n = this;
        return a = !o && r.length ? e.extend.apply(null, [!0, a].concat(r)) : a,
        o && "_" === a.charAt(0) ? n : (o ? this.each(function() {
            var o = e(this).data(i)
              , s = o && e.isFunction(o[a]) ? o[a].apply(o, r) : o;
            if (s !== o && s !== t)
                return n = s,
                !1
        }) : this.each(function() {
            e(this).data(i, new e.lunaradioMarquee(this,a))
        }),
        n)
    }
    ,
    e.lunaradioMarquee = function(e, t) {
        var a, i, o = 0, r = 0, n = e.dataset.speed || .25, s = e.dataset.reverse, l = e.parentElement.getBoundingClientRect(), d = e.children[0];
        d.innerHTML;
        function c() {
            var e = d.cloneNode(!0);
        ...
        function u() {
            (s ? r < 0 : r > -1 * i) ? r -= n * (s ? -1 : 1) : r = s ? -1 * i : 0,
            a.style.whiteSpace = "nowrap",
            a.style.transform = "translate(" + r + "px, 0) translateZ(0)",
        ...
        (a = document.createElement("div")).style.whiteSpace = "nowrap",
        function() {
            d.style.display = "inline-block",
            i = d.offsetWidth,
            i > l.width ? 2 : Math.ceil((l.width - i) / i) + 1;
            for (var t = 0; t < 20; t++)
                c();
            s && (r = -1 * i);
...
function(e) {
    ...
    var t = e.extend
      ...
      , s = "touchend";
    function l(t, a, i) {
        if ("touch" !== a.substr(0, 5))
            return e(t).unbind(a, i);
        var o;
        for (o = 0; o < d._binds.length; o++)
            d._binds[o].elem === t && d._binds[o].type === a && d._binds[o].func === i && (document.addEventListener ? t.removeEventListener(a, d._binds[o].fnc, !1) : t.detachEvent("on" + a, d._binds[o].fnc),
            d._binds.splice(o--, 1))
    }
    function d(t, a, i, o) {
        return "touch" !== a.substr(0, 5) ? e(t).bind(a, o, i) : d[a] ? d[a].bind(t, a, i, o) : (r = function(e) {
            e || (e = window.event),
        ...
        ,
        document.addEventListener ? t.addEventListener(a, r, !1) : t.attachEvent("on" + a, r),
        void d._binds.push({
            elem: t,
            type: a,
            func: i,
    ...
    function c(e) {
        ...
        e.data.event = e,
        e.data.onstart && e.data.onstart.call(e.data.element, e.data) || (e.preventDefault && e.data.preventDefault && e.preventDefault(),
        e.stopPropagation && e.data.stopPropagation && e.stopPropagation(),
        d(e.data.affects, i, u, e.data),
        d(e.data.affects, o, p, e.data))
    }
    function u(e) {
    ...
    function h(e) {
        ...
        e.data.onstart && e.data.onstart.call(e.data.element, e.data) || (e.preventDefault && e.data.preventDefault && e.preventDefault(),
        e.stopPropagation && e.data.stopPropagation && e.stopPropagation(),
        d(e.data.affects, n, m, e.data),
        d(e.data.affects, s, g, e.data))
    }
    function m(e) {
        e.preventDefault && e.data.preventDefault && e.preventDefault(),
        e.stopPropagation && e.data.stopPropagation && e.stopPropagation(),
    ...
    d._binds = [],
    e.fn.lunaradiograb = function(e, i) {
